...
소스 57개, 개념 133개, 개체 29개, 분석 16개와 메타 문서 3개, 총 238개 Markdown 문서가 있다. 전체 문서는 스키마 v2를 따르며 213개는 `verified`, 해석적 문서 22개는 `partial`, 철학적 결론이 논쟁 중인 문서 3개는 `disputed`다. 263개 외부 근거와 114개 불변 raw artifact가 레지스트리에 등록돼 있다.
