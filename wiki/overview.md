...
소스 22개, 개념 74개, 개체 27개, 분석 8개와 메타 문서 3개, 총 134개 Markdown 문서가 있다. 전체 문서는 스키마 v2를 따르며 117개는 `verified`, 해석적 문서 14개는 `partial`, 철학적 결론이 논쟁 중인 문서 3개는 `disputed`다. 115개 외부 근거와 44개 불변 raw artifact가 레지스트리에 등록돼 있다.
