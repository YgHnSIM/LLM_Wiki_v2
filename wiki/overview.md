...
- [[사전 학습 지식은 과제에 어떻게 도착하는가]]에서 비교하는 ELMo 고정 특징, 전체 미세조정, 입력 cue·demonstration, 다과제 지시, CLIP class prompt, Flamingo의 동결 백본–학습 bridge–멀티모달 context와 Codex 실행 선택 및 foundation model–adapted model–deployed system의 층위·접근권
