...
소스 8개, 개념 52개, 개체 16개, 분석 7개와 메타 문서 3개, 총 86개 Markdown 문서가 있다. 전체 문서는 스키마 v2로 마이그레이션됐으며 74개는 `verified`, 해석적 분석과 논쟁적 개념 12개는 `partial`이다. 32개 외부 근거와 16개 불변 raw artifact가 레지스트리에 등록돼 있다.
