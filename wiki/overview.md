...
처음부터 모든 문서를 순서대로 읽을 필요는 없다. 비메타 문서를 쉬운 핵심, 작동 원리, 기술과 근거의 세 단계로 재구성하고 있다. 현재 source 001–019와 이 자료에서 처음 등장한 관련 concept·entity 96개까지 1차 배치를 완료했으며, 예전 구조로 남은 비메타 문서는 124개다. 전환된 문서에서 모르는 수식이 나오면 1단계와 2단계만 읽고 관련 개념으로 이동한 뒤 돌아와도 된다.
