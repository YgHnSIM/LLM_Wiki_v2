...
소스 53개, 개념 128개, 개체 29개, 분석 15개와 메타 문서 3개, 총 228개 Markdown 문서가 있다. 전체 문서는 스키마 v2를 따르며 204개는 `verified`, 해석적 문서 21개는 `partial`, 철학적 결론이 논쟁 중인 문서 3개는 `disputed`다. 252개 외부 근거와 106개 불변 raw artifact가 레지스트리에 등록돼 있다.
