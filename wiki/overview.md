...
처음부터 모든 문서를 순서대로 읽을 필요는 없다. 비메타 문서를 쉬운 핵심, 작동 원리, 기술과 근거의 세 단계로 재구성하고 있다. 현재 source 001–059와 이 자료에서 처음 등장한 관련 concept·entity 164개까지 3차 배치를 완료했으며, 예전 구조로 남은 비메타 문서는 analysis 16개다. 전환된 문서에서 모르는 수식이 나오면 1단계와 2단계만 읽고 관련 개념으로 이동한 뒤 돌아와도 된다.
...
| 현대 Transformer 계열은 어디서 왔나 | [[018_역전파와 다층 신경망 학습]] | [[045_Sequence-to-Sequence 학습과 신경 기계 번역]] → [[054_Transformer와 자기어텐션 기반 시퀀스 모델링]] | [[057_BERT의 마스크드 양방향 사전 학습]]·[[058_GPT-1과 GPT-2의 전이 방식 변화]] |
