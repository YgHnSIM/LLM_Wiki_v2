...
InstructGPT가 세 단계 RLHF를 처음 발명한 것은 아니다. [[055_RLHF 토대와 인간 선호 기반 보상 학습]]이 다루듯 Christiano 등은 2017년 행동 구간 비교에서 보상을 학습했고, Ziegler 등은 2019년 언어 모델 출력에 이를 적용했으며, Stiennon 등은 2020년 요약 응답 비교·보상 모델·PPO 정책을 실증했다.
