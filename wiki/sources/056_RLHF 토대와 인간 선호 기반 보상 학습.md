...
- 2017년 연구는 짧은 행동 구간의 인간 비교로 보상 모델을 학습하고 정책을 반복 갱신하는 틀을 보였다.
...
논문은 Atari와 MuJoCo형 시뮬레이션 로봇 이동·제어 과제를 다루었다. 인간이 환경과의 상호작용 중 1% 미만을 관찰하고 비교를 제공하면서 복잡한 과제를 학습할 수 있다고 보고했고, 일부 새 행동에는 약 한 시간의 인간 시간이 들었다.
