...
대화 형식은 한 답으로 요청이 끝나지 않아도 되게 한다. 사용자는 follow-up question으로 조건을 추가하고, 잘못된 답을 지적하고, 모호했던 의도를 다시 표현할 수 있다. Model도 앞선 turn에 이어 답하고 잘못을 인정하거나 잘못된 전제에 이의를 제기하는 행동을 낼 수 있다.
