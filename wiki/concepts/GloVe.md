...
1. GloVe에서 전역이라는 말은 어떤 국소 단어–문맥 사건을 어떻게 집계한다는 뜻인가?
2. 가중 log-bilinear 목적은 단어·문맥 벡터와 편향으로 어떤 값을 근사하는가?
3. GloVe가 모든 과제에서 Word2Vec보다 우월하거나 문맥별 의미를 표현한다고 일반화할 수 없는 이유는 무엇인가?
