...
[[WaveNet]]은 앞선 오디오 표본을 조건으로 다음 표본의 확률분포를 예측하는 2016년의 자기회귀 원시 파형 생성 모델이다. 팽창 인과 합성곱으로 미래 표본을 보지 않으면서 수천 시점의 수용 영역을 만들고, 음성 합성에서 당시 연결형·매개변수형 기준선보다 높은 자연스러움 평가를 얻었다.
