...
- [[084_Flamingo와 게이트 교차 어텐션 기반 퓨샷 시각-언어 학습]] — 원문 서사를 model 수치·평가 protocol·실패 사례로 검증한다.
- [[CLIP]] — 전역 유사도 기반 후보 비교와 생성형 cross-attention interface를 비교한다.
- [[문맥 내 학습]] — demonstration이 weight가 아니라 현재 context에 들어가는 적응을 설명한다.
