...
1. Word2Vec가 하나의 고정 신경망이 아니라 모델·도구군이라는 말은 어떤 선택들을 가리키는가?
2. SGNS는 관측 중심–문맥 쌍과 음성 쌍의 점곱을 각각 어떤 방향으로 학습하는가?
3. 유추 성과와 FastText 확장이 문맥별 의미·장거리 구조를 자동 해결하지 않는 이유는 무엇인가?
